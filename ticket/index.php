				...
				<div class="columns three">
					<div class="profile">
						...
						<ul>
							...
							<li><?php if ($users->idtocolumn($tickets->ticket_info($_GET['id'], 'user'), 'user_group') == 1) {
									echo 'Administrator';
								} else {
									echo 'General user';
								} ?></li>
							<?php if ($users->idtocolumn($tickets->ticket_info($_GET['id'], 'user'), 'id') == $_COOKIE['user']) {
								echo '<li><a href="../settings">Edit Account</a></li>';
							} ?>
						</ul>
					</div>
				</div>
				...
				<div class="columns nine">
					...
					<ul>
						<li><?php if ($tickets->ticket_info($_GET['id'], 'resolved') == 0 && $tickets->ticket_info($_GET['id'], 'user') == $_COOKIE['user']) { ?>
							...
							<?php } else if ($users->getuserinfo('user_group') == 1 && $tickets->ticket_info($_GET['id'], 'resolved') == 0) { ?>
						</li>
				...
				<div class="columns three">
					<div class="profile">
						...
						<ul>
							...
							<li><?php if ($users->getuserinfo('user_group') == 1) {
									echo 'Administrator';
								} else {
									echo 'General user';
								} ?></li>
							<li><a href="../settings">Edit Account</a></li>
						</ul>
					</div>
				</div>
				<?php
