		<ul>
			...
			<a href="./">
				<li<?php if ($admin_menu_active == 'dashboard') {
						echo ' class="active"';
					} ?>>
					Admin Dashboard
			...
			<a href="ticket_management.php">
				<li<?php if ($admin_menu_active == 'ticket_management') {
						echo ' class="active"';
					} ?>>
					Tickets Management
			...
			<a href="user_management.php">
				<li<?php if ($admin_menu_active == 'user_management') {
						echo ' class="active"';
					} ?>>
					User Management
			...
			<a href="site_management.php">
				<li<?php if ($admin_menu_active == 'site_management') {
						echo ' class="active"';
					} ?>>
					Site Management
